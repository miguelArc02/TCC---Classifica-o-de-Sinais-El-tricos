...
OUTPUT_DIR = Path(__file__).resolve().parent / "Resultados" / "Resultados Testes" / "Teste 4 - FFT & SVM"
...
DIR_DOMINIO_FOURIER = os.path.join(
    OUTPUT_DIR,
    "Dominio_Fourier"
)
...
# =============================================================================
# 6B. [NOVO] IDENTIFICADORES DOS SINAIS
# =============================================================================
#
# Cria um identificador por sinal, no formato "classe_000", "classe_001",
# apenas para rastrear cada sinal nos novos arquivos de saída (não é usado
# como característica).
#
# =============================================================================
...
# Renderiza a matriz com o mesmo estilo usado no FFT_RF_v2.py.
...
def executar_pipeline():
    ...
    # =========================================================================
    # [NOVO] SALVA A REPRESENTAÇÃO DOS SINAIS NO DOMÍNIO DE FOURIER
    # =========================================================================
    #
    # Aqui é salvo o espectro de amplitude COMPLETO (1281 componentes) de
    # cada sinal — os dados de processamento em si, antes de qualquer
    # filtro de correlação ou seleção Fisher.
    #
    # =========================================================================

    ids_sinais = gerar_identificadores(y)
    ...
    df_dominio_fourier = pd.DataFrame(
        X_fft,
        columns=colunas_fft
    )

    df_dominio_fourier["classe"] = y

    df_dominio_fourier["ID_sinal"] = ids_sinais

    arquivo_dominio_fourier = os.path.join(
        DIR_DOMINIO_FOURIER,
        "representacao_dominio_fourier_SVM.csv"
    )

    df_dominio_fourier.to_csv(
        arquivo_dominio_fourier,
        index=False
    )
    ...
    print(
        f"Representação no domínio de Fourier salva em: "
        f"{arquivo_dominio_fourier}"
    )
